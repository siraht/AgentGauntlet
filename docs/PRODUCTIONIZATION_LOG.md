...
| Coverage and complexity debt   | Active   | 106 tests plus 78 subtests pass; whole-tree coverage is 56.76% / 43.95% with 51 complexity blockers; the latest complete local mutation campaign scored 54.70% with zero incomplete mutants; deep run `20260727-051119-97495607` refused its 4,117-line mutation scope with structured exit 2. |
