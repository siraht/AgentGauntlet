...
| Coverage and complexity debt   | Active   | 64 tests pass; whole-library line coverage is 57.46% and branch coverage 42.63%; governance boundaries improved; 52 inherited complexity blockers remain. |
