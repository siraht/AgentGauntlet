...
| Coverage and complexity debt   | Active   | 91 tests plus 73 subtests pass; whole-tree coverage is 55.41% / 43.05% with 54 complexity blockers; mutation executed 9,421 mutants at 53.48%; exact-current deep evidence is being regenerated.                                         |
