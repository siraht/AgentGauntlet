...
| Coverage and complexity debt   | Active   | 125 tests plus 89 subtests pass; the last whole-tree coverage measurement is 57.51% / 44.26% with 51 complexity blockers; the complete branch campaign scored 54.70%; the recent hardening slice killed all 141 selected mutants with zero survivors or incomplete work; fast run `20260727-130856-df78bcb0` remains honestly red on inherited structure debt. |
