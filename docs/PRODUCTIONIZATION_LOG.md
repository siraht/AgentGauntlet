...
| Coverage and complexity debt   | Active   | 125 tests plus 89 subtests pass; current whole-tree coverage is 58.26% / 45.44% with 42 complexity blockers; the complete branch campaign scored 54.70%; the recent hardening slice killed all 141 selected mutants with zero survivors or incomplete work; fast run `20260727-130856-df78bcb0` remains honestly red on inherited structure debt. |
