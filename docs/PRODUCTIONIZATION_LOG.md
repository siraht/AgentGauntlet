...
| Coverage and complexity debt   | Active   | 105 tests plus 78 subtests pass; whole-tree coverage is 57.07% / 44.29% with 51 complexity blockers; the latest complete local mutation campaign scored 54.70% with zero incomplete mutants; exact-current deep run `20260727-043005-6ab00271` refused its 4,049-line mutation scope in 181 ms with structured exit 2. |
