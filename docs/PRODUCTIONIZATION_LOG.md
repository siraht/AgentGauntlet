...
| Coverage and complexity debt   | Active   | 90 tests plus 73 subtests pass; the last whole-tree baseline is 54.43% / 41.51% with 54 complexity blockers; mutation executed 9,421 mutants at 53.48%; exact-current deep evidence is being regenerated.                                |
