...
| Coverage and complexity debt   | Active   | 97 tests plus 73 subtests pass; whole-tree coverage is 56.12% / 43.65% with 52 complexity blockers; the latest complete local mutation campaign scored 54.70% with zero incomplete mutants; bounded exact-current evidence is rerunning. |
