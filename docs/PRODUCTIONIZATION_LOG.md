...
| Coverage and complexity debt   | Active   | 108 tests plus 78 subtests pass; whole-tree coverage is 57.51% / 44.26% with 51 complexity blockers; the full campaign scored 54.70%, and the 51-line release slice scored 65.52%, both with zero incomplete mutants; deep run `20260727-054515-6baccba4` refused its 4,163-line mutation scope with structured exit 2. |
