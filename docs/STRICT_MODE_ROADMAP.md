...
Revision: `a37c5d545dba0f72d4fe0377b39aa9cdabba61ac` · mode: **adopt** · strict ready: **no**

## Current evidence

- Tests: 93
- Line coverage: 55.55% (gap 29.45 points)
- Branch coverage: 43.24% (gap 31.76 points)
