...
class GitHubGovernanceContractTests(unittest.TestCase):
    ...
    def test_repository_review_scope_uses_the_published_mainline(self) -> None:
        ...
        self.assertEqual(
            ...
            ["tests", "quality/tests", "agent_ergonomics_audit/audit/regression_tests"],
        )
        self.assertEqual(project["paths"]["tests"], project["python"]["test_paths"])
    ...
    def test_authoritative_profile_installs_browser_and_retains_checker_reports(self) -> None:
        ...
        self.assertIn("check-risk --shadow --keep-going --quiet", workflow)
        self.assertIn("check-risk --keep-going --quiet", workflow)
