...
def _review_purpose_decision(purpose: str) -> str:
    ...
    return (
        ...
        "non-empty claim names every affected test path and explains why each preserves or "
        "strengthens its removed oracles. Cite both current.diff.patch and review/current.json "
        "in that finding. "
