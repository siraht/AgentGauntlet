...
const thresholds = merge(
  project.thresholds || {},
  project.profile_thresholds?.[profile] || {},
);
const enforceGlobalCoverage = project.enforcement?.scope === "full";
const sourceRoots = project.paths?.source?.length
...
export default defineConfig({
  test: {
    ...
    coverage: {
      ...
      thresholds: enforceGlobalCoverage
        ? {
